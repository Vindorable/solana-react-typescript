...
// Ref: https://github.com/ArweaveTeam/arweave-js#npm-web
type ValueClusterType = {
  host: string;
  port: number;
  protocol: string;
};
...
const ArweaveClusterContextProvider: FC<Props> = ({ children }) => {
...
export default ArweaveClusterContextProvider;